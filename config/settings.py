...
SECRET_KEY = "django-insecure-&k*t(nr0c4+bc7+4e61)1!qzt)0#^5j(r2ho3cri5!ucjp%4w6"
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'dele',  # The password for the user
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://127.0.0.1:6379/1",  # Use database number 1
        "OPTIONS": {
